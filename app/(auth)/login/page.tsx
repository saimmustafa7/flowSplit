      ...
      <div className="w-full max-w-md bg-[var(--bg-card)]/80 backdrop-blur-xl rounded-2xl p-8 border border-[var(--border)] shadow-2xl relative z-10">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6 font-satoshi">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 mt-2 bg-accent hover:bg-accent/90 text-white rounded-lg font-bold transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none disabled:transform-none flex items-center justify-center h-14"
          >
            {loading ? (
